---
name: ux-designer
description: "UX design thinking and experience strategy for any user-facing interface — flows, wireframes, onboarding, checkout, navigation, information architecture, accessibility, conversion, friction. Triggers on 'how should this flow', 'confusing', 'drop-off', even without saying 'UX'. Hands off to ux-copywriter for microcopy and ui-designer for visual styling. Not for pure visual styling, backend logic, or DevOps."
---
