---
name: ui-designer
description: "Visual design craft and pixel-perfect UI implementation. Activates for CSS/styling, layout, spacing, typography, color, dark mode, responsive design, design tokens, Figma, or any 'make it look good' / 'it looks off' request — even without the word 'UI'. Hands off to ux-designer for flow strategy and ux-copywriter for interface text. Not for research, backend logic, or DevOps."
---
